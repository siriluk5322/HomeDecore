...
import kotlinx.android.synthetic.main.fragment_product_type_segment.producttype_recycler_view
...
class HistoryOrderFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerHistory.layoutManager = LinearLayoutManager(activity?.applicationContext)
